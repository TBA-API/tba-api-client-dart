...
**declines** | **List&lt;String&gt;** | List of teams that declined the alliance. | [optional] [default to const []]
**picks** | **List&lt;String&gt;** | List of team keys picked for the alliance. First pick is captain. | [default to const []]
