...
void main() {
  ...
  group('test EventRanking', () {
    ...
    // List<EventRankingRankings> rankings (default value: const [])
    ...
    // List<EventRankingExtraStatsInfo> extraStatsInfo (default value: const [])
    test('to test the property `extraStatsInfo`', () async {
      // TODO
    });

    // List of year-specific values provided in the `sort_orders` array for each team.
    // List<EventRankingSortOrderInfo> sortOrderInfo (default value: const [])
