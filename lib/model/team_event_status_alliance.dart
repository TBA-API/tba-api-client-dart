...
class TeamEventStatusAlliance {
  ...
  static List<TeamEventStatusAlliance> listFromJson(List<dynamic> json) {
    return json == null ? List<TeamEventStatusAlliance>() : json.map((value) => TeamEventStatusAlliance.fromJson(value)).toList();
  }

  static Map<String, TeamEventStatusAlliance> mapFromJson(Map<String, dynamic> json) {
    var map = Map<String, TeamEventStatusAlliance>();
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic value) => map[key] = TeamEventStatusAlliance.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of TeamEventStatusAlliance-objects as value to a dart map
  static Map<String, List<TeamEventStatusAlliance>> mapListFromJson(Map<String, dynamic> json) {
