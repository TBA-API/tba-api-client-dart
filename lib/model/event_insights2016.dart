...
class EventInsights2016 {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (aChevalDeFrise != null)
      json['A_ChevalDeFrise'] = aChevalDeFrise;
    if (aPortcullis != null)
      json['A_Portcullis'] = aPortcullis;
    if (bRamparts != null)
      json['B_Ramparts'] = bRamparts;
    if (bMoat != null)
      json['B_Moat'] = bMoat;
    if (cSallyPort != null)
      json['C_SallyPort'] = cSallyPort;
    if (cDrawbridge != null)
      json['C_Drawbridge'] = cDrawbridge;
    if (dRoughTerrain != null)
      json['D_RoughTerrain'] = dRoughTerrain;
    if (dRockWall != null)
      json['D_RockWall'] = dRockWall;
    ...
    if (averageAutoScore != null)
      json['average_auto_score'] = averageAutoScore;
  ...
  static List<EventInsights2016> listFromJson(List<dynamic> json) {
    return json == null ? List<EventInsights2016>() : json.map((value) => EventInsights2016.fromJson(value)).toList();
  }

  static Map<String, EventInsights2016> mapFromJson(Map<String, dynamic> json) {
    var map = Map<String, EventInsights2016>();
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic value) => map[key] = EventInsights2016.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of EventInsights2016-objects as value to a dart map
  static Map<String, List<EventInsights2016>> mapListFromJson(Map<String, dynamic> json) {
