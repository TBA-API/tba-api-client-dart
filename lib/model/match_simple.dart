...
class MatchSimple {
  ...
  static List<MatchSimple> listFromJson(List<dynamic> json) {
    return json == null ? List<MatchSimple>() : json.map((value) => MatchSimple.fromJson(value)).toList();
  }

  static Map<String, MatchSimple> mapFromJson(Map<String, dynamic> json) {
    var map = Map<String, MatchSimple>();
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic value) => map[key] = MatchSimple.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of MatchSimple-objects as value to a dart map
  static Map<String, List<MatchSimple>> mapListFromJson(Map<String, dynamic> json) {
