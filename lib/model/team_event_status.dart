...
class TeamEventStatus {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (playoffStatusStr != null)
      json['playoff_status_str'] = playoffStatusStr;
    if (overallStatusStr != null)
      json['overall_status_str'] = overallStatusStr;
    if (nextMatchKey != null)
      json['next_match_key'] = nextMatchKey;
    if (lastMatchKey != null)
      json['last_match_key'] = lastMatchKey;
    return json;
  }

  static List<TeamEventStatus> listFromJson(List<dynamic> json) {
    return json == null ? List<TeamEventStatus>() : json.map((value) => TeamEventStatus.fromJson(value)).toList();
  }

  static Map<String, TeamEventStatus> mapFromJson(Map<String, dynamic> json) {
    var map = Map<String, TeamEventStatus>();
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic value) => map[key] = TeamEventStatus.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of TeamEventStatus-objects as value to a dart map
  static Map<String, List<TeamEventStatus>> mapListFromJson(Map<String, dynamic> json) {
