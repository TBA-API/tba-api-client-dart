...
class Zebra {
  ...
  Zebra.fromJson(Map<String, dynamic> json) {
    ...
    times = (json['times'] == null) ?
      null :
      (json['times'] as List).cast<double>();
  ...
  static List<Zebra> listFromJson(List<dynamic> json) {
    return json == null ? List<Zebra>() : json.map((value) => Zebra.fromJson(value)).toList();
  }

  static Map<String, Zebra> mapFromJson(Map<String, dynamic> json) {
    var map = Map<String, Zebra>();
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic value) => map[key] = Zebra.fromJson(value));
    }
    return map;
  }
