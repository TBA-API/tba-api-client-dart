...
class EliminationAllianceStatus {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (playoffAverage != null)
      json['playoff_average'] = playoffAverage;
    if (level != null)
      json['level'] = level;
    if (record != null)
      json['record'] = record;
  ...
  static List<EliminationAllianceStatus> listFromJson(List<dynamic> json) {
    return json == null ? List<EliminationAllianceStatus>() : json.map((value) => EliminationAllianceStatus.fromJson(value)).toList();
  }

  static Map<String, EliminationAllianceStatus> mapFromJson(Map<String, dynamic> json) {
    var map = Map<String, EliminationAllianceStatus>();
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic value) => map[key] = EliminationAllianceStatus.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of EliminationAllianceStatus-objects as value to a dart map
  static Map<String, List<EliminationAllianceStatus>> mapListFromJson(Map<String, dynamic> json) {
