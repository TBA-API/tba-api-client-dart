...
class APIStatusAppVersion {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (minAppVersion != null)
      json['min_app_version'] = minAppVersion;
    if (latestAppVersion != null)
      json['latest_app_version'] = latestAppVersion;
    return json;
  }

  static List<APIStatusAppVersion> listFromJson(List<dynamic> json) {
    return json == null ? List<APIStatusAppVersion>() : json.map((value) => APIStatusAppVersion.fromJson(value)).toList();
  }

  static Map<String, APIStatusAppVersion> mapFromJson(Map<String, dynamic> json) {
    var map = Map<String, APIStatusAppVersion>();
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic value) => map[key] = APIStatusAppVersion.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of APIStatusAppVersion-objects as value to a dart map
  static Map<String, List<APIStatusAppVersion>> mapListFromJson(Map<String, dynamic> json) {
